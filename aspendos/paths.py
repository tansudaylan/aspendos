"""Repository-local runtime paths for Aspendos."""

import os
from pathlib import Path


PATH_ENV_VAR = "ASPENDOS_PATH"


def get_repository_path() -> Path:
    """Return the repository path configured by ASPENDOS_PATH."""
...
def get_data_path() -> Path:
    """Return the ignored runtime data directory."""

    return get_repository_path() / "data"


def get_visuals_path() -> Path:
    """Return the ignored runtime visualization directory."""
